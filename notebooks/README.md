...
| [lab-09-comparison-summary.ipynb](lab-09-comparison-summary.ipynb) | — | `visual_nlp` | A 2-question × 4-mode matrix plus every lab's recorded run, with a mode-selection guide. |
